 ...
 * this file.
 */
static void prvSmpTaskTwo( void *pvParameters );
static void prvSmpTaskOne( void *pvParameters );
...
int main( void )
{
	...
	UBaseType_t uxCoreAffinityMask = ~0UL;
	...
	of this file. */
	xTaskCreateAffinitySet(     /* The function that implements the task. */
		prvSmpTaskOne,
...
static void prvSmpTaskOne( void *pvParameters )
{
	...
	for( ;; )
	{
		...
		sprintf( buf, "Hello from SMP Task One\r");
		vSendString(buf);
	}
}
/*-----------------------------------------------------------*/
...
static void prvSmpTaskTwo( void *pvParameters )
{
	...
	for( ;; )
	{
		...
		sprintf( buf, "Hello from SMP Task Two\r");
		vSendString(buf);
	}
}
/*-----------------------------------------------------------*/
