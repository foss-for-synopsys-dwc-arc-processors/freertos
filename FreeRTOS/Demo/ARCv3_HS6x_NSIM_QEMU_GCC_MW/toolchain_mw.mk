...
CCORE_OPT_MW += -arc64 -core0 -HL -Xcode_density -Xswap -Xbitscan -Xbarrel_shifter -Xtimer0 -Xtimer1 -Xstack_check -Hccm -Xdmac \
							  -Ml -Wa,-offwarn=168

ifdef MW_HS6X_LIB
	CCORE_OPT_MW += -Hlib=$(MW_HS6X_LIB)
endif
...
LINK_OPT += $(LCORE_OPT_MW)   $(ADT_LOPT) -Hpurge -Hnocopyr -Hnosdata -Hnocrt $(LMAP_OPTION) $(APPL_LINK_FILE)
